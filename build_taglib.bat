...
"%CMAKEDIR%\cmake" .. -G Ninja -DBUILD_SHARED_LIBS=%DYNAMIC% -DCMAKE_SUPPRESS_REGENERATION=1 -DZLIB_INCLUDE_DIR=%INCLUDE_DIR% -DZLIB_LIBRARY=%LIB_DIR%\%ZLIBNAME% -DCMAKE_INSTALL_PREFIX=%ROOT_DIR%
IF ERRORLEVEL 1 (
    SET VALRETURN=1
	goto END
)
